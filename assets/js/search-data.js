      ...
      window.location.href = "/al-folio/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-i-will-attend-the-upcoming-conference-on-issre-2025-and-present-my-research-automatic-data-repair-without-format-specifications",
          title: 'I will attend the upcoming conference on ISSRE 2025 and present my research...',
          description: "",
          section: "News",},{id: "projects-grammar-bench",
          title: 'Grammar-bench',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/1_project/";
            },},{id: "projects-readme2artifacts",
          title: 'Readme2artifacts',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/2_project/";
            },},{id: "projects-deeplang",
          title: 'Deeplang',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/3_project/";
            },},{id: "projects-threadedvm",
          title: 'ThreadedVM',
          description: "",
          section: "Projects",handler: () => {
              window.location.href = "/al-folio/projects/4_project/";
            },},{id: "projects-autogrammar",
          title: 'AutoGrammar',
          description: "",
          section: "Projects",handler: () => {
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%6C%7A%69%6A%35%39%32%33@%75%6E%69.%73%79%64%6E%65%79.%65%64%75.%61%75", "_blank");
        },
      },{
        id: 'social-inspire',
        title: 'Inspire HEP',
